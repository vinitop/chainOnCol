...
import { useWallet } from '@fantom/wallet-adapter-react'
...
import { Connection, clusterApiUrl, PublicKey } from '@fantom/web3.js'
...
export const Form = () => {
	...
	const connection = new Connection('https://fantom-devnet.g.alchemy.com/v2/ueL5_rfSA-5XWPHsXCVBZ9A-CsqD0Dqe')
